 ...
 *
 * Oct 2006, Frank Bergmann <something@tuxad.com>
 * - set e_shentsize (default value of 40 on i386/32bit)
 * - don't use *printf and stdio: smaller code and dietlibc "friendly"
 */
...
/**
 * bswap_* taken from dietlibc
 * <byteswap.h> is GNUish and not portable
 */
...
static int err(char const *errmsg)
{
    ...
    return (write(2, errmsg, str_len(errmsg))==-1);
}
